...
- `dashboard_where.png`, `dashboard_why.png` — screenshots of the final Power BI dashboard, shown below

## Dashboard

### Where customers are churning
![Where dashboard](./dashboard_where.png)

### Why customers are churning
![Why dashboard](./dashboard_why.png)
