...
* `dashboard\_where.png`, `dashboard\_why.png` - screenshots of the final Power BI dashboard, shown below
...
!\[Where dashboard](./dashboard\_where.png)

### Why customers are churning

!\[Why dashboard](./dashboard\_why.png)
